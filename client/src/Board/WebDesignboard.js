...
function WebDesignboard() {
  ...
  return (
    <div className={`${styles.boardViewBox} ${styles.wdboardViewBox}`}>
      ...
      <>
      {contentShow?
        <div className={`${styles.contentBox} ${styles.webdesignContentBox} webdesignContentBox`} ref={scrollRef}>
      {selectedPost && (
        <div>
      ...
      <div className={`${styles.boardBigtitle} ${styles.WebdesignBigtitle}`}>
        <h1>- Web Design -</h1>
      </div>
      </>
    }
