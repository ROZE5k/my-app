...
function GraphicDesign() {
  ...
  return (
    <div className={styles.boardViewBox}>
      <div className={`${styles.thumbBox} ${styles.iluthumbBox} ${isMobile&&styles.mobileiluthumbBox}`}>
        {/* 모든 썸네일 보여주기 */}
        {posts.map((post) => (
      ...
      {/* 선택된 게시글 내용 보여주기 */}
      {contentShow?
      <div className={`${styles.contentBox} ${styles.ilucontentBox} ${isMobile&&styles.mobileilucontentBox}`} ref={scrollRef}>
      {selectedPost && (
        <div>
          <div className={styles.contentDetail} onClick={closeContent}>
