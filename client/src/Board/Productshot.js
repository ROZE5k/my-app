...
function Productshot() {
  ...
  return (
    <div className={styles.boardViewBox}>
      ...
      <>
      {contentShow?
        <div className={`${styles.contentBox} ${styles.productshotContentBox} productshotContentBox`} ref={scrollRef}>
      {selectedPost && (
        <div>
          <div className={styles.contentThumb} dangerouslySetInnerHTML={{ __html: selectedPost.thumb }}></div>
      ...
      <div className={`${styles.boardBigtitle} ${styles.productshotTitle}`}>
