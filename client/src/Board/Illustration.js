...
function Illustration() {
  ...
  return (
    <div className={`${styles.boardViewBox} ${isMobile&&styles.mobileBoardViewBox}`}>
      <div className={`${styles.thumbBox} ${styles.iluthumbBox}`}>
        {/* 모든 썸네일 보여주기 */}
        {posts.map((post) => (
      ...
      {/* 선택된 게시글 내용 보여주기 */}
      {contentShow?
      <div className={`${styles.contentBox} ${styles.ilucontentBox}`} ref={scrollRef} onClick={closeContent}>
      {selectedPost && (
        <div>
